...
Shader "Custom/blarpHead" {
 ...
 Properties {
    ...
    _IntersectionPrecision( "Intersection Precision" , Float ) = 0.000001
...
//
     ...
     // Fragment Shader
      fixed4 frag(VertexOut i) : COLOR {
        ...
        col = col * texCUBE( _CubeMap , normalize(refl) ).xyz;
        ...
        col = lerp( col , m * m , _Evil);
        //col = lerp( col , float3( m  , m , m) );
        //col = float3(1,1,1);
